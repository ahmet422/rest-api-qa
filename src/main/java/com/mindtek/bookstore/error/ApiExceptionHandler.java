...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiError> constraints(ConstraintViolationException ex, HttpServletRequest req) {
        List<FieldErrorDto> fields =
    ...
    public ResponseEntity<ApiError> conflict(DataIntegrityViolationException ex, HttpServletRequest req) {
        ...
        String lower = ex.getMostSpecificCause().getMessage() != null
